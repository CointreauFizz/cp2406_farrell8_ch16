...
public class Exer2_JChangeSizeAndColorPanel extends JPanel implements ActionListener
{
    ...
    public Exer2_JChangeSizeAndColorPanel()
    {
    ...
    public static void main(String[] args)
    {
        ...
        frame.add(new Exer2_JChangeSizeAndColorPanel());
