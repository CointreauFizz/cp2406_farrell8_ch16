...
public class Exer2_JChangeSizeAndColorPanel2 extends JPanel implements ActionListener
{
    ...
    public Exer2_JChangeSizeAndColorPanel2()
    {
    ...
    public static void main(String[] args)
    {
        ...
        frame.add(new Exer2_JChangeSizeAndColorPanel2());
